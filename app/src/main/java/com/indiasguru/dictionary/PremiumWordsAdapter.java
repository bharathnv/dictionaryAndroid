...
public class PremiumWordsAdapter extends RecyclerView.Adapter<PremiumWordsAdapter.ViewHolder> {
    public PremiumWordsAdapter(List<PremiumWord> premiumWordList, Context context) {
